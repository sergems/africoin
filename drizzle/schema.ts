...
export const wallets = mysqlTable("wallets", {
  id: int("id").autoincrement().primaryKey(),
  userId: int("userId").notNull(),
  currency: mysqlEnum("currency", ["CDF", "USD", "KES", "NGN", "ZAR", "GHS", "UGX", "TZS", "RWF", "JPY", "CAD", "CHF", "CNH"]).notNull(),
...
export const instruments = mysqlTable("instruments", {
  ...
  assetClass: mysqlEnum("assetClass", ["equity", "fx_spot", "index"]).notNull(),
...
export const orders = mysqlTable("orders", {
  ...
  marginUsed: decimal("marginUsed", { precision: 24, scale: 8 }),
